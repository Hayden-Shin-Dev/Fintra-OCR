"""Standalone production rule kernel copied from the frozen active extraction behavior.\n\nThis module has no runtime dependency on the legacy documents/refinement modules.\n"""
...
def _refine(result, document):
    from .production_refinement import typed_refinement, ordered_refinement
    ...
    if result.document_type == "Commercial Invoice" and hasattr(refined, "items"):
        from .production_table import extract_header_relative_items
