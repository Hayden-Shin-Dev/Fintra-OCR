...
|---|---|---|---|---|---|---|---|
| IMG_OCR_6_T_BL_001677 | bill_of_lading | consignee | EXTRACTION_MISSING | "Tlease proydde compleee name" | null | True | semantic GT field bbox unavailable |
| IMG_OCR_6_T_BL_002596 | bill_of_lading | consignee | WRONG_SELECTION | "LERN TECHNOLOGY GROUP" | "LERN TECHNOLOGY GROUP" | True | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_000322 | commercial_invoice | amount | OCR_MISSING | {"value": 39583.47, "symbol": "$", "currency_code": null} | "$39,583.7" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001677 | commercial_invoice | amount | OCR_MISSING | {"value": 12003.64, "symbol": "$", "currency_code": null} | "$12,003.6" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001677 | commercial_invoice | invoice_no | OCR_MISSING | "210217" | "895-353-5469" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001774 | commercial_invoice | amount | OCR_MISSING | {"value": 38904.35, "symbol": "$", "currency_code": null} | "$38900435" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001825 | commercial_invoice | amount | OCR_MISSING | {"value": 30333.65, "symbol": "$", "currency_code": null} | "$30,333.6" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001825 | commercial_invoice | invoice_no | OCR_MISSING | "233963" | "233965" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001943 | commercial_invoice | amount | OCR_MISSING | {"value": 19000.01, "symbol": "$", "currency_code": null} | null | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001943 | commercial_invoice | currency | OCR_MISSING | {"code": "USD", "symbol": null} | null | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_001943 | commercial_invoice | invoice_no | OCR_MISSING | "311992" | "311999" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_002913 | commercial_invoice | amount | OCR_MISSING | {"value": 49180.67, "symbol": "$", "currency_code": null} | "$49,180.7" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_002913 | commercial_invoice | currency | OCR_MISSING | {"code": "CAD", "symbol": null} | "$" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_002913 | commercial_invoice | invoice_no | OCR_MISSING | "807797" | "316-937-4094" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_BL_003578 | bill_of_lading | consignee | OCR_MISSING | "QHOENIX TELECOM" | "WINNIE,," | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_003235 | commercial_invoice | amount | OCR_MISSING | {"value": 3985.55, "symbol": "$", "currency_code": null} | null | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_NV_003382 | commercial_invoice | quantity | OCR_MISSING | {"items": [{"value": 30, "unit": null}]} | null | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
| IMG_OCR_6_T_PL_004301 | packing_list | quantity | OCR_MISSING | {"items": [{"value": 1, "unit": null}, {"value": 4, "unit": null}, {"value": 3, "unit": null}]} | "4 | 3" | False | reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy |
...
- Expected raw text: ``
- Expected bbox: `null` (semantic GT field bbox unavailable)
...
- Expected bbox: `[[79, 687], [358, 687], [358, 710], [79, 710]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `True`
...
- Expected bbox: `[[938, 1793], [1063, 1793], [1063, 1827], [938, 1827]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
...
- Expected bbox: `[[938, 1793], [1100, 1793], [1100, 1828], [938, 1828]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[830, 293], [938, 293], [938, 327], [830, 327]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[938, 1793], [1054, 1793], [1054, 1828], [938, 1828]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[830, 293], [910, 293], [910, 328], [830, 328]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[938, 1793], [1080, 1793], [1080, 1826], [938, 1826]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
- Selected candidate: `{"value": null, "raw_text": "", "source_indices": [], "bbox": null, "predictions": []}`
- Stored-vs-reconstructed oracle conflict: `False`; true failure under reconstructed oracle: `True`
...
- Expected bbox: `[[1377, 1861], [1432, 1861], [1432, 1892], [1377, 1892]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
- Selected candidate: `{"value": null, "raw_text": "", "source_indices": [], "bbox": null, "predictions": []}`
- Stored-vs-reconstructed oracle conflict: `False`; true failure under reconstructed oracle: `True`
...
- Expected bbox: `[[830, 293], [927, 293], [927, 327], [830, 327]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[938, 1793], [1080, 1793], [1080, 1828], [938, 1828]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[1377, 1861], [1439, 1861], [1439, 1890], [1377, 1890]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[830, 293], [924, 293], [924, 328], [830, 328]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[122, 395], [391, 395], [391, 427], [122, 427]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
...
- Expected bbox: `[[332, 1619], [440, 1619], [440, 1648], [332, 1648]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
- Selected candidate: `{"value": null, "raw_text": "", "source_indices": [], "bbox": null, "predictions": []}`
- Stored-vs-reconstructed oracle conflict: `False`; true failure under reconstructed oracle: `True`
...
- Expected bbox: `[[368, 499], [391, 499], [391, 516], [368, 516]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
- Selected candidate: `{"value": null, "raw_text": "", "source_indices": [], "bbox": null, "predictions": []}`
- Stored-vs-reconstructed oracle conflict: `False`; true failure under reconstructed oracle: `True`
...
- Expected bbox: `[[930, 1133], [946, 1133], [946, 1401], [930, 1401]]` (reconstructed oracle field bbox from GT value boxes; semantic field identity remains a proxy)
- Expected text in raw OCR: `False`
- Raw matches: `[]`
