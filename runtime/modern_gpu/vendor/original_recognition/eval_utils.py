...
def get_args(is_train=True):
    ...
    # for test
    # parser.add_argument('--image_folder', required=True, help='path to evaluation dataset')
    ...
    parser.add_argument(
        "--saved_model",
        # default="/workspace/recognition_weight_latest/iter_60000.pth",
        default="/workspace/text_recognition_baseline/saved_models/vitstr_small_patch16_224-Seed1111/best_accuracy.pth",
    ...
    parser.add_argument("--json_path", default='/workspace/text_recognition_baseline/annotations/resize_global_research_insure_final_0130_validation.json')
    parser.add_argument("--result_pkl", default='/workspace/new_mmocr/inference_pkl/insure_results.pkl')
    parser.add_argument("--image_root_path", default='/workspace/resize_images')
    parser.add_argument("--dict_path", default='/workspace/resize_images')
